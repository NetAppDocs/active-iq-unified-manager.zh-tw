...
---
= 使用 Active IQ Unified Manager 事件 API 確定儲存設備物件問題
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/handling_event_related_issues_of_a_storage_object_flowchart.gif[流程圖展示了從事件清單到修正行動再到結束的 Volume 事件分析流程。]
