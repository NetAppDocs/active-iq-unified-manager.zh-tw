...
---
= 使用 Active IQ Unified Manager 閘道 API 對 ONTAP 磁碟區進行故障排除
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/api_gateway_ontap_workflow.gif[一張圖表，展示 Unified Manager 和 ONTAP API 疑難排解 Volume 容量警示的步驟。]
