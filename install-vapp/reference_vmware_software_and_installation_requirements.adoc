...
---
= 了解 Active IQ Unified Manager 的 VMware 軟體和安裝需求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
在 VMware vSphere 系統上執行的 Unified Manager OVA 內部運行的是 Debian OS 13 (Trixie)。有關支援的 ESXi 伺服器版本所支援的虛擬機器硬體版本的資訊，請參閱 VMware 文件。
