...
此外，在安裝第二個 Unified Manager 實例之前，單一 Unified Manager 實例可以監控的節點數量是有限制的。有關節點限制、CPU 和記憶體建議，請參閱 link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["統一管理最佳實務指南"^]。
