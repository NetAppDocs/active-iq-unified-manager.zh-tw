...
[role="lead"]
您只能將Active IQ Unified Manager從版本 9.14 或 9.16 升級到版本 9.18。
...
[NOTE]
====
如果您的系統是從 Unified Manager 9.7 升級而來，由於 Debian 版本中的檔案系統發生了變化，您無法直接從 9.14 升級到 9.18。請依照以下建議的升級路徑進行：9.14 -> 9.16P2 -> 9.18。
