...
---
= 停用 Active IQ Unified Manager 中已解決與已過時事件的警報
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
對於所有已配置為發送警報的事件，當這些事件經歷所有可用狀態（New、Resolved 和 Obsolete）時，系統都會發送警報訊息。如果您不希望接收事件進入 Resolved 和 Obsolete 狀態時的警報，您可以設定全域設定來抑制這些警報。
