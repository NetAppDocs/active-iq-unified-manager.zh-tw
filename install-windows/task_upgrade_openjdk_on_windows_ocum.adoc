...
您可以在發行系列中更新OpenJDK版本。例如、您可以從OpenJD11.0.12升級至OpenJD11.0.13、但無法直接從OpenJD11更新至OpenJD12。
...
. 展開「壓縮」檔案。
. 將目錄和檔案從產生的「JDK"目錄（例如、「JDK-11.0.13」）複製到安裝Java的位置。範例：「C:\Program Files\NetApp\JDK\」
