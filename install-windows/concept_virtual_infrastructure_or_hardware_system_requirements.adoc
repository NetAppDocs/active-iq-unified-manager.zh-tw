...
此外，單一 Unified Manager 實例可監控的節點數量有限，超過此限制後，您需要安裝第二個 Unified Manager 實例。有關節點限制、CPU 和記憶體建議，請參閱 https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["統一管理最佳實務指南"^]。
