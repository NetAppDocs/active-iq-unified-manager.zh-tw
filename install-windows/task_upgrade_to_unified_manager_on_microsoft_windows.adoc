...
[role="lead"]
您可以在Windows平台上下載並執行安裝檔案、將Unified Manager 9.9或9.10升級至9.11。
...
====
* MySQL Community Edition會在Unified Manager升級期間自動升級。如果您系統上安裝的MySQL版本早於8.0.28、Unified Manager升級程序會自動將MySQL升級至8.0.28。您不得執行舊版MySQL的獨立升級至8.0.27。
