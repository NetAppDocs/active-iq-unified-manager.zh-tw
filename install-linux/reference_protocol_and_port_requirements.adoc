...
NOTE: MySQL的預設連接埠3306僅限在Linux系統上安裝Unified Manager時使用localhost。這不會影響任何維持先前組態的升級案例。您可以修改此組態、並使用維護主控台的「Control access to MySQL port 3306」（控制存取MySQL連接埠3306）選項、將連線提供給其他主機。
