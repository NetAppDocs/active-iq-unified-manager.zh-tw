...
[role="lead"]
利用VMware（前身為VMware Unified Manager）、您可以從單一介面監控及管理您的VMware儲存系統的健全狀況和效能。Active IQ Unified Manager OnCommand ONTAP您可以將Unified Manager部署在Linux伺服器、Windows伺服器或VMware主機上的虛擬應用裝置（vApp）上。
