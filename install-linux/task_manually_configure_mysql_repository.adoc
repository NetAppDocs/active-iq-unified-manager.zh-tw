...
---
= 設定 Active IQ Unified Manager 的 MySQL 儲存庫
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
對於 Red Hat Enterprise Linux 8 系統，如果您有包含 java-17-openjdk、7-zip 和其他由 AppStream 儲存庫提供的軟體包的內部儲存庫，則必須停用 AppStream 儲存庫並安裝 MySQL Community Server。運行以下命令：
