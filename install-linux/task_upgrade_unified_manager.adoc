...
* 在升級 Unified Manager 之前，必須先安裝或升級到正確版本的 7-zip。看 link:task_configure_7zip_package.html["配置 7-zip 軟體包"]。
...
* Unified Manager 升級期間，MySQL Community Edition 會自動升級。如果系統上安裝的 MySQL 版本低於 8.4.10，Unified Manager 升級程序會自動將 MySQL 升級至 8.4.10。
