...
---
= 了解 Active IQ Unified Manager 如何監控 VMware 虛擬化基礎架構
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/vm_deployment.gif[一張顯示 VMware 主機、虛擬機器、資料儲存、VMDK、IP 網路和儲存設備連線的圖表]

*使用者工作流程*

下圖顯示使用VM拓撲檢視的典型使用案例：

image::../media/vm_workflow.gif[此圖展示了在運算、網路和儲存設備層中定位虛擬機器應用程式延遲的工作流程。]
